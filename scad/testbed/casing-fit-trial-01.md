...
type: log
date: 2026-07-04
testbed: casing-fit-test v0.1.0, casing.scad v0.9.0, and peg_socket_fit_testbed v0.3.0
status: planned; flat casing with stack sockets restored 2026-07-05
---
...
| Regular 23u casing fit target | Full-depth slot behavior for the flat-side/back representative casing, including visible stack sockets. | Final clearance recipe unless tested against a real printed tub and recorded; validated peg/stack behavior. | `2974.7cm^3` |
...
| Regular 23u casing fit target | Manifold with stack sockets visible on both socket faces | `389.2 x 280.2 x 94.24mm` | `389.2 x 280.2 x 94.24mm` | Match |
...
| Peg socket placement | Enabled in `casing.scad` v0.9.0; sockets center in the flat side/back wall footprints |
